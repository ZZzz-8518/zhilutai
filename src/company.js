const WATCHLIST = [
  ...
  ['远景能源', ['远景能源', '远景科技'], '大型民企或大厂', ['风电', '新能源', '制造', '结构', '工程'], 7, '7-9月秋招', '网申、测评、面试', 'https://envision-career.com/'],
...
const DOMAIN_SEARCH_EXPANSIONS = {
  ...
  civil: ['比亚迪', '吉利汽车', '上汽集团', '小鹏汽车', '蔚来', '理想汽车', '小米集团', '宁德时代',
    '京东方', '中国中车', '三一集团', '徐工集团', '中国商飞', '中国航天科技', '中国航空工业',
    '华为', '美的集团', '海尔集团', '金风科技', '远景能源', '阳光电源', '隆基绿能', '中联重科',
    '中国重汽', '潍柴动力', '海信集团', '东方电气', '上海电气', '哈尔滨电气集团', '特变电工'],
